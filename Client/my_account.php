...
$user = $fetch_data->getSingleItem("SELECT name, username, tel", 'Company', 'id', $_SESSION['client_id']);
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="POST" action="../Submits/client_update_account.php">
                                <input type="hidden" name="id" value="<?php echo $_SESSION['client_id']; ?>" required>
                                    <div class="row">
                                        <div class="col-md-12">
