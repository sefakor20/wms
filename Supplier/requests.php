...
$pagination = $fetch_data->getTwoFieldsTotal('Warehouse_Stock_Request', 'supplier_id', $_SESSION['sup_id'], 'request_status', 2);
...
$all_requests = $fetch_data->getMultipleDataCompare("SELECT Warehouse_Stock_Request.id, request_status, Item.name AS item, Category.name AS category, quantity, Request_Status.name AS r_status, Warehouse_Stock_Request.created_at", 'Warehouse_Stock_Request', "JOIN Item ON Item.id = Warehouse_Stock_Request.item_id JOIN Category ON Category.id = Warehouse_Stock_Request.category_id JOIN Request_Status ON Request_Status.id = Warehouse_Stock_Request.request_status", 'supplier_id', $_SESSION['sup_id'], 'request_status', 2, $rows, $offset);
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover">
                                    ...
                                    <?php foreach($all_requests as $req): ?>
                                        <tr>
                                            ...
                                            <td><a href="release_stock.php?id=<?php echo $req->id; ?>">Release Stock</a> | <a href="send_notice.php?id=<?php echo $req->id; ?>">Send Notice</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                                </table>
                                ...
                                <ul class="pagination pagination-sm no-margin pull-right">
                                    <?php if(($page - 1) >= 1): ?>
                                      <li><a href="requests.php?page=<?php echo $prevPage; ?>">&laquo; Prev</a></li>
                                    <?php endif; ?>
                                    <?php if(($page + 1) <= $pages): ?>
                                      <li><a href="requests.php?page=<?php echo $nextPage; ?>">Next &raquo;</a></li>
                                    <?php endif; ?>
                                </ul>
