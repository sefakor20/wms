                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="text-right"><a href="attendance_reports_pdf.php" target="_blank" class="btn btn-sm btn-danger"><i class="pe-7s-print"> Print Report</i></a></p>
                            </div>
                                    ...
                                    <tbody>
                                        <?php foreach($reports as $rep): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $date_format->time_elapsed_string($rep->created_at) ?></td>
                                                <td>
                                                <?php
                                                    if ($rep->personnel_id == $_SESSION['gen_user']) {
                                                        ?>
                                                        <a href="edit_report.php?id=<?php echo $rep->id; ?>">Edit Report</a>
                                                        <?php
                                                    } else {
                                                        echo "No activities";
                                                    }
