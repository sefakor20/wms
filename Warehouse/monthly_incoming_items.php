...
$pagination = $fetch_data->dailyTotalWarehouse('Warehouse_All_Stock', $from, $to);
...
$stocks = $fetch_data->getDailyItems("SELECT Item.name AS item_name, Category.name AS category_name, quantity, CONCAT(User.first_name, ' ', User.last_name, ' ', User.other_name) AS personnel, expiry_date, Company.name AS supplier, Warehouse_All_Stock.created_at", 'Warehouse_All_Stock', "JOIN Item ON Item.id = Warehouse_All_Stock.item_id JOIN Category ON Category.id = Warehouse_All_Stock.category_id JOIN User ON User.id = Warehouse_All_Stock.personnel_id JOIN Company ON Company.id = Warehouse_All_Stock.supplier_id", "Warehouse_All_Stock", $from, $to, $rows, $offset);
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Current Month's Incoming Items</h4>
                            ...
                            <div class="content table-responsive table-full-width">
                                ...
                                <ul class="pagination pagination-sm no-margin pull-right">
                                    <?php if(($page - 1) >= 1): ?>
                                      <li><a href="daily_incoming_items.php?page=<?php echo $prevPage; ?>">&laquo; Prev</a></li>
                                    <?php endif; ?>
                                    <?php if(($page + 1) <= $pages): ?>
                                      <li><a href="daily_incoming_items.php?page=<?php echo $nextPage; ?>">Next &raquo;</a></li>
                                    <?php endif; ?>
                                </ul>
