...
<head>
	...
	<title>Admin - Stock Waiting Approval</title>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php foreach($items as $item): ?>
                                        <tr>
                                            ...
                                            <a href="../Submits/approves.php?wa_id=<?php echo $item->id; ?>&personnel_id=<?php echo $_SESSION['admin']; ?>&item_id=<?php echo $item->item_id; ?>&category_id=<?php echo $item->category_id; ?>&released_quantity=<?php echo $item->released_quantity; ?>&expiry=<?php echo $item->expiry_date; ?>&supplier_id=<?php echo $item->supplier_id; ?>">Approve Stock</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
