                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form>
                                    ...
                                    <a href="../Submits/approves.php?wa_id=<?php echo $selected_item->id; ?>&personnel_id=<?php echo $_SESSION['admin']; ?>&item_id=<?php echo $selected_item->item_id; ?>&category_id=<?php echo $selected_item->category_id; ?>&released_quantity=<?php echo $selected_item->released_quantity; ?>&expiry=<?php echo $selected_item->expiry_date; ?>&supplier_id=<?php echo $selected_item->supplier_id; ?>" class="btn btn-info btn-fill pull-right">Approve Stock</a>
