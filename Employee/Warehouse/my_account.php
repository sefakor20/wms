...
$user = $fetch_data->getSingleItem("SELECT first_name, last_name, other_name, username", 'User', 'id', $_SESSION['gen_user']);
...
<head>
	...
	<title>Employee - My Account</title>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Making changes to your account</p>
                            </div>
                            <div class="content">
                                <form method="POST" action="../../Submits/employee_update_account.php">
                                <input type="hidden" name="id" value="<?php echo $_SESSION['gen_user']; ?>" required>
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="other_name" value ="<?php echo $user->other_name; ?>">
                                            </div>
                                        </div>
                                    </div>
