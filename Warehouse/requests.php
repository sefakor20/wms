...
$pagination = $fetch_data->paginationTotal('Client_Stock_Request');
...
$requests = $fetch_data->getItemsWithLimitOffset("SELECT Client_Stock_Request.id, Item.name AS item_name, Category.name AS category_name, quantity, Request_Status.name AS notice, Client_Stock_Request.status, Company.name AS client, Client_Stock_Request.created_at", 'Client_Stock_Request', "JOIN Item ON Item.id = Client_Stock_Request.item_id JOIN Category ON Category.id = Client_Stock_Request.category_id JOIN Company ON Company.id = Client_Stock_Request.client_id JOIN Request_Status ON Request_Status.id = Client_Stock_Request.status", $rows, $offset);
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="pull-right">
                                <form method="GET" action="./find_requests.php">
