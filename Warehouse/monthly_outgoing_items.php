...
$pagination = $fetch_data->dailyTotalWarehouse('Warehouse_Release_Stock', $from_month, $to_month);
...
<head>
	...
	<title>Admin - Monthly Outgoing Items</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Current Month's Outgoing Items</h4>
                            ...
                            <div class="content table-responsive table-full-width">
                                ...
                                <ul class="pagination pagination-sm no-margin pull-right">
                                    <?php if(($page - 1) >= 1): ?>
                                      <li><a href="monthly_outgoing_items.php?page=<?php echo $prevPage; ?>">&laquo; Prev</a></li>
                                    <?php endif; ?>
                                    <?php if(($page + 1) <= $pages): ?>
                                      <li><a href="monthly_outgoing_items.php?page=<?php echo $nextPage; ?>">Next &raquo;</a></li>
                                    <?php endif; ?>
                                </ul>
